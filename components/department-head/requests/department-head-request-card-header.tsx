...
export function DepartmentHeadRequestCardHeader({ requestGroup }: { requestGroup: RequestGroup }) {
  return (
...
export function useDepartmentHeadRequestCardHeader() {
  return useCallback(
    (requestGroup: RequestGroup) => (
      <DepartmentHeadRequestCardHeader requestGroup={requestGroup} />
    ),
    []
  );
}
