...
type ClientNewsMobileViewProps = UseClientNewsPageResult;

/** Mobile client news list — parity с workflow-mobile app/client/news.tsx. */
export function ClientNewsMobileView({
  searchQuery,
  setSearchQuery,
  filterDate,
  setFilterDate,
  ...
  return (
    <>
      ...
      >
        ...
        <div className="mx-4 mt-3 mb-2 flex items-center gap-2 rounded-xl border border-hairline bg-surface-2 px-3 py-2.5">
        ...
        <div className="px-4 pb-3 border-b border-hairline/60">
          <div className="flex items-center gap-3 mt-2">
            ...
            <Select value={filterDate} onValueChange={(v) => setFilterDate(v as NewsDateFilter)}>
              <SelectTrigger className="flex-1 h-10 bg-surface-2 border-hairline text-white">
